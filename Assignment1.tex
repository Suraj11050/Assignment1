...
\noindent Then,\\
$P(X=0) = \dfrac{25}{36}$  \\ 
For each dice probability of not getting six as an outcome is $\frac{5}{6}$
as both dice are independent with each other outcomes \\
P(No dice gives outcome 6) = $\frac{5}{6}\times\frac{5}{6} =\frac{25}{36} $ \\
\null \par
$P(X=1) = \dfrac{10}{36}$  \\
P(At least one dice gives outcome 6) $=\,^{2}C_{1}\times\frac{1}{6}\times\frac{5}{6}$
$=\frac{10}{36}$ \\
\null \par
$P(X=2) = \dfrac{1}{36}$ \\
P(Both getting an outcome of 6) = $\frac{1}{6}\times\frac{1}{6}=\frac{1}{36}$ \\
\newpage
